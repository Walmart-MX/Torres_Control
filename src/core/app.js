 ...
 *   5. Inicializar el catálogo de operadores
 *   6. Establecer el estado visual inicial del pipeline
 *   7. Mostrar el modal de bienvenida en el primer uso
 *
 * CATALOG_DATA: el array embebido del catálogo permanece en index.html
 * como constante global hasta la integración con Supabase (Camino B),
 * donde migrará a la tabla `operators`. Se recibe aquí como parámetro
 * para no crear una dependencia del módulo hacia el HTML.
 *
...
import { initCatalog, saveCatalog } from '../features/catalog.js';

/**
 * Inicializa la aplicación completa.
 * @param {Array<{op:string, lic:string}>} catalogData — array CATALOG_DATA de index.html
 */
export function init(catalogData) {
